...
def genPomdpXFile(spaceArr, velocityArr, orientationArr, goalPositions, adaptiveLevels, T, workerPolicies):
	pomdpXFile = open("../pomdp_files/2d_robot_worker.pomdpx", "w")
...
if __name__ == "__main__":
	...
	simMapFile = open("../results/simulatedMap" + str(workerGoalIdx) + ".txt", "w")
	opfile = open("../results/positions" + str(workerGoalIdx) + ".txt", "w")
	logFile = open("../results/log" + str(workerGoalIdx) + ".txt","w")
